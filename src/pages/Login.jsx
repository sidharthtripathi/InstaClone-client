            ...
            <div className='space-y-2'>
                <div>
                    <form className="space-y-2">
                        ...
                        <button className="hover:scale-95 bg-blue-500 hover:bg-blue-400 duration-100 w-full h-10 cursor-pointer rounded-md text-white font-semibold" onClick={handleSubmit}>Login</button>
