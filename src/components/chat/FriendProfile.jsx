...
function FriendProfile({avatar,username,lastMsg,pendingMsgCount=0}) {
  const [pending,setPending] = useState(false)
  return (
    <div className='h-16 flex p-2 hover:bg-blue-500 duration-100 rounded-md'>
    <img className="h-full rounded-full" src={"https://www.elevenforum.com/data/attachments/45/45622-423967e182ed610e64465704d26689f8.jpg"} alt="userDP" />
